...
func TestSwitchDelivery(t *testing.T) {
	...
	n1 := host.NewHost(1, "00:00:00:00:00:01", "192.168.1.1/24", 1500, nes)
	n2 := host.NewHost(2, "00:00:00:00:00:02", "192.168.1.2/24", 1500, nes)
	s1 := nswitch.NewSwitch(nes, 3, "192.168.1.3/24", "00:00:00:00:00:03")
	...
	n1.SetTraffic("00:00:00:00:00:02", "192.168.1.2/24", 8000, 1.0, 10.0, 20, 1000, 1.0)
